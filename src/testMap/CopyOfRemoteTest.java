...
public class CopyOfRemoteTest {
	...
	public static void setUp() throws MalformedURLException {
		...
		driverChrome = new RemoteWebDriver(new URL("http://localhost:4444/wd/hub"), capabilities);
						...
						try {
							if (weImg.getAttribute("src").contains(
								...
								try {// try is needed because some Elementa are
									...
									CopyOfRemoteTest RemoteTest = new CopyOfRemoteTest();
	...
	static void testingBoundaryManager() throws InterruptedException {
		...
		try {
			...
			try {
				...
				CopyOfRemoteTest RemoteTest2 = new CopyOfRemoteTest();
